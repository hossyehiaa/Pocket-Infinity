...
export function playGunshot() {
  ...
  // Create a realistic gunshot using noise and oscillators
  ...
  // Add a low-frequency thump for realism
  const oscillator = ctx.createOscillator();
  const oscGain = ctx.createGain();
